            ...
            <img src={`data:image/png;base64,${profileImage}`} alt="Profile" className="w-full h-full object-cover" />
                ...
                <div>
                  <h2 className="text-2xl font-semibold text-gray-800">
                    Name:{masterProfile.fullName || "John Doe"}
                  </h2>
                  <p className="text-sm text-gray-500">Email:{masterProfile.email || "johndoe@example.com"}</p>
                  <p className="text-sm text-gray-500">Phone No:{masterProfile.contactNumber || "N/A"}</p>
                </div>
              </div>
...
export default managementGovtProfile;
