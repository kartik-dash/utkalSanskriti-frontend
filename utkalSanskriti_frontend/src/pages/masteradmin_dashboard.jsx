...
import { Chart as ChartJS, LinearScale, CategoryScale, ArcElement, Title, Tooltip, Legend } from 'chart.js';
      ...
      <div className="mster_view_body">
        ...
        <div className="mster_view_card">
          <div className="card-box bg-blue">
            <div className="inner">
              <h3>Admin</h3>
              <p>{overallCounts?.ADMIN ?? 0}</p>
            </div>
            <div className="icon">
              <MdOutlineAdminPanelSettings size={72} />
            </div>
            <Link to="/masteradmin-viewmore?role=ADMIN" className="card-box-footer">
