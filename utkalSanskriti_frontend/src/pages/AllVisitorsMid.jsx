    ...
    <div className="p-6">
      ...
      {showModal && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white p-6 rounded shadow-lg m-4 w-[840px]">
                  ...
                  {totalTeam.length > 0 ? (
                    totalTeam.map((user) => (
                      <tr key={user.userId} className="text-center">
                        ...
                        <td className="border p-2">{user.contactNumber || "N/A"}</td>
