...
const teamleadchatPage = () => {
  ...
  const roles = [
    ...
    { id: 2, displayName: 'ADMIN', apiRole: 'ADMIN' },
    { id: 3, displayName: 'TOP LEVEL', apiRole: 'TOP_LEVEL' },
    { id: 4, displayName: 'MID LEVEL', apiRole: 'MID_LEVEL' },
...
export default teamleadchatPage;
