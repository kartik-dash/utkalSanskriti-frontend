...
// const Manage_Gov_ManagementLayout = () => {
...
// export default Manage_Gov_ManagementLayout;
...
const [sidebarOpen, setSidebarOpen] = useState(false);
  ...
  if (!Array.isArray(ManagementRoutes)) {
    console.error("ManagementRoutes is not an array:", ManagementRoutes);
