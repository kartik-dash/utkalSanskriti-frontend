...
// const Support_ManagementLayout = () => {
...
// export default Support_ManagementLayout;
...
const [sidebarOpen, setSidebarOpen] = useState(false);
  ...
  if (!Array.isArray(SupportRoutes)) {
    console.error("SupportRoutes is not an array:", SupportRoutes);
