...
// import LowerRoutes from '../routes/LowRoutes';
// import { useSelector } from "react-redux";


// const Low_Level_ManagementLayout = () => {
...
// export default Low_Level_ManagementLayout;
...
const [sidebarOpen, setSidebarOpen] = useState(false);
  ...
  if (!Array.isArray(LowerRoutes)) {
    console.error("LowerRoutes is not an array:", LowerRoutes);
