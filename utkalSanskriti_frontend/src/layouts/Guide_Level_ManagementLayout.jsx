...
// const Guide_Level_ManagementLayout = () => {
...
// export default Guide_Level_ManagementLayout;
...
const [sidebarOpen, setSidebarOpen] = useState(false);
  ...
  if (!Array.isArray(GuideRoutes)) {
    console.error("GuideRoutes is not an array:", GuideRoutes);
