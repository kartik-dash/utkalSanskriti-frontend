...
const [sidebarOpen, setSidebarOpen] = useState(false);
  ...
  if (!Array.isArray(AdminRoutes)) {
    console.error("AdminRoutes is not an array:", AdminRoutes);
...
//             {/* {/ Sidebar Toggle Button for Mobile /} */}
//             <button
//               className="fixed Toggle_Button_rem bg-gray-900 text-white p-2 rounded-full shadow-lg lg:hidden"
//               onClick={toggleSidebar}
//             >
//               {sidebarOpen ? <X size={24} /> : <Menu size={24} />}
//             </button>
...
//             {/* {/ Main Page Content /} */}
//             <main className="flex-grow rem_left_rightpdd overflow-auto">
//               <Routes>
