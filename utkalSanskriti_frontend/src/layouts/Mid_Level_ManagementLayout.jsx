...
// import MidRoutes from '../routes/MidRoutes';
// import { useSelector } from "react-redux";


// const Mid_Level_ManagementLayout = () => {
...
// export default Mid_Level_ManagementLayout;
...
const [sidebarOpen, setSidebarOpen] = useState(false);
  ...
  if (!Array.isArray(MidRoutes)) {
    console.error("MidRoutes is not an array:", MidRoutes);
