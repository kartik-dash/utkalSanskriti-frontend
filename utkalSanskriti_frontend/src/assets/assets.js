...
export const categories = [
  ...
  //puri district 
  {
    ...
    products: [
      ...
      },
      {
        ...
        description: "Maa Mangal Temple in Jagatsinghpur, Odisha, is a revered site dedicated to Goddess Mangal, symbolizing protection, strength, and prosperity.",
        price: "$999",
        details: `Maa Mangala Temple, located in Jagatsinghpur, Odisha, is a revered Hindu temple dedicated to Goddess Mangal, known for her role as a protector and symbol of strength. The temple attracts numerous devotees who seek her blessings for prosperity, success, and protection. The temple is especially significant for its spiritual and cultural importance in the region.
                  The architecture of Maa Mangal Temple reflects traditional Odisha temple designs, with intricate carvings and serene surroundings that create an atmosphere of devotion and peace. It is said that Maa Mangal, as a form of the Goddess Durga, provides spiritual and physical protection to her devotees, and offers a sense of peace in times of distress.
                  The temple is a center of various religious rituals, including special prayers during festivals, especially during the Mangal Jayanti, which celebrates the goddess. Devotees gather to offer flowers, fruits, and other offerings while chanting hymns and prayers. The temple's significance continues to grow as it plays a central role in maintaining the cultural and spiritual heritage of Jagatsinghpur.`,
        ...
        festivals: [
          {
            ...
            description: [`One of the most profound and intense expressions of devotion at the temple is the annual ritual where male devotees, known as ‘Bhaktas’, walk barefoot across burning embers to seek the blessings of Maa Mangala. This act is not driven by spectacle or thrill, but is a deeply spiritual offering. Each step taken on the fiery path symbolizes a prayer, sacrifice, and a complete surrender to the goddess.
                          ...
                          `Pana Sankranti is a festival that celebrates new beginnings and honors the nurturing aspect of Maa Mangala at the Maa Mangala Temple in Kakatpur, Jagatsinghpur. Held during the Chaitra month (March–April), it signifies the arrival of the solar new year and the beginning of the harvest season.
...

  {
    ...
    products: [
...

      {
        ...
        rituals_img: [,null,null,null,null,null,null,null,null,null,null,null,null,null,],
        ...
        about_rituals: [` The temple would typically open early in the morning. Based on information for other Jagannath temples, this could be around 5:00 AM to 6:00 AM.`,
          `The first ritual would likely be the Mangala Aarti, the auspicious offering of lamps to the deities Lord Jagannath, Balabhadra, and Subhadra.`,
          `This involves the removal of the previous night's decorations and attire of the deities.`,
          ` A symbolic cleansing ritual for the deities.`,
          ` The deities are dressed in new clothes and adorned with flowers and ornaments for the day. The specific attire might vary depending on the day of the week.`,
          `A light breakfast offering to the deities.`,
          ` A more elaborate offering of food in the late morning. This is a significant part of the daily rituals in Jagannath temples.`,
          ` A public offering of food, usually in the temple hall.`,
          ` Another substantial food offering in the afternoon.`,
          ` The evening Aarti to the deities.`,
          ` An evening food offering.`,
          ` In the late evening, sandalwood paste mixed with other fragrant ingredients is applied to the deities.`,
          ` The final dressing of the deities in their night attire.`,
          `The deities are ritually put to rest for the night, and the temple doors are closed. This usually happens around 9:00 PM to 10:00 PM.`
        ],
        festivals: [
          {
            ...
            img: [null,null,null,null,null,null,null,null,null,null,null,null,null,],
            description: [ ` Celebrated on the full moon day of Jyestha (May-June), this marks the ceremonial bathing of the deities (Jagannath, Balabhadra, and Subhadra) before they go into the Anasara period.`,
              ` Following the Snana Yatra, the deities are believed to fall ill and are kept in seclusion for about 15 days. During this time, special secret rituals are performed by specific servitors.`,
              `Just before the Ratha Yatra, the deities reappear to the public in their youthful forms after the Anasara. This is a significant event for devotees.`,
              `The most prominent festival, usually held in June or July (Asadha month). The deities are taken out of the temple in grand chariots and travel to the Gundicha Temple (in Puri, but Dhyankud might have a symbolic representation or a smaller procession).`,
              ` Celebrated on the fifth day of the Ratha Yatra, marking Goddess Lakshmi's visit to the Gundicha Temple to see Lord Jagannath.`,
              `The return journey of the deities from the Gundicha Temple back to the main temple.`,
              `After the Bahuda Yatra, the deities are adorned in magnificent golden attire on their chariots.`,
              `A special offering of a refreshing drink to the deities on their chariots before they re-enter the temple.`,
              ` The ceremonial entry of the deities back into the sanctum sanctorum of the main temple, marking the end of the Ratha Yatra.`,
              `A long festival starting from Akshaya Tritiya (April-May) and lasting for about 42 days, involving the application of sandalwood paste to the deities and processions.`,
              `Celebrated in February-March (Phalguna), involving the deities being placed on swings and joyous celebrations with colors.`,
              ` Celebrated in January, marking the winter solstice with special offerings.`,
              `The coronation ceremony of Lord Jagannath, observed on the full moon day of Pausha (December-January).`
            ],
          }
        ],
        calender: [
      ...
      {
        id: 104,
        name: "Jaganath Temple Gadakujang",
        location: "JAGATSINGHPUR,ODISHA,INDIA",
        latitude: 20.31583256697464,
        longitude: 86.26471952964188,
        temple: "yes",
        ...
        rituals_img: [null,null,null,null,null,null,null,null,null,null,null,null,null,null,],
        rituals_name: [`Morning Opening`,`Mangala Aarti`,`Mailam`,`Abakasha (Morning Ablutions)`,`Besa (Dressing and Adornment)`,`Gopal Ballav Bhoga`,`Sakala Dhupa`,`Bhoga Mandap`,`Madhyanha Dhupa`,`Sandhya Aarti`,`Sandhya Dhupa`,`Chandana Lagi`,`Badasinghara Besha`,`Pahuda `],
        about_rituals: [` The temple would typically open early in the morning. Based on information for other Jagannath temples, this could be around 5:00 AM to 6:00 AM.`,
          `The first ritual would likely be the Mangala Aarti, the auspicious offering of lamps to the deities Lord Jagannath, Balabhadra, and Subhadra.`,
          `This involves the removal of the previous night's decorations and attire of the deities.`,
...

  {
    ...
    products: [
        ...
        festivals: [
          {
            ...
            img: [],
            description: [`On the auspicious day of Chaitra Purnima, the deities are adorned in the Raghunath Besha, where Shree Jagannath is dressed as Shree Rama and Balaram becomes Laxman. According to the Ramayana Mahapuran, during the Tretaya Yuga, Shree Krishna and Shree Jagannath incarnated as the elder brother and Laxman, respectively.
                         In this tradition, Mahalakshmi is represented as Mata Sita. However, it is noted that Subhadra does not embody the avatar of Sita. Hence, this special Besha is primarily performed in Vishnu temples. This Besha, which holds profound significance, is an extraordinary and epoch-making celebration.
                         Saint Tulsidas, the composer of the Ramcharitmanas, wrote his epic while journeying along the banks of the Sarayu River. While reading the Ramayana composed by Maharishi Valmiki, particularly the Uttarakanda, Tulsidas witnessed a conversation between Shree Ram and Bibhishan, the ruler of Lanka. In this conversation, Shree Ram prophesied that in Kaliyuga, Purusottama Jagannath would incarnate as Shree Ram: “Aradhyaya Purusottamam Ikshyaku kula daibatam.”
                         Tulsidas, deeply moved by this verse, made his way to Puri Dham. He was the chief disciple of Rai Ramananda and Shree Narahari. Upon reaching the sacred Puri, he saw the magnificent, though partially constructed, idols of Lord Jagannath, Shree Balabhadra, and Maa Subhadra. Overcome with sorrow, he prepared to leave, but one night, while resting near the Tulasi Chaunra, he experienced a divine vision. Lord Jagannath, holding the Dhanu Sara (bow) and Tuniara (quiver), appeared to Tulsidas in a transcendent form. As his heart softened, he heard the divine words: “Johi Rama Sohi Jagadisho Dina hi anta na pabata sesa’ Sesa bhaye laxman anuchari Bhadraso sio rajakumari” (Ramcharitmanas by Tulsidas).
                         This divine encounter occurred on a Thursday, coinciding with the Ekadasi tithi. Since that day, the Raghunath Besha rituals have been performed on the Ekadasi tithi that falls on a Thursday. Following Niti Ballabha Dhupa, this Besha is observed before the Badasinghara Ulagi Parba begins. The Badasinghara Besha follows as part of the daily rituals, and this tradition continues as an integral part of the nitya Besha.
                         This Besha is not just a ritual but a profound expression of devotion and divinity, symbolizing the eternal presence of Shree Ram and Shree Laxman in the form of Lord Jagannath and Lord Balabhadra.`   ,
      ...
      },
      {
        ...
        shakti_pitha: "no",
        west: "yes",
        image: "/kendrapada-img/chandaneswar-temple.jpg",
        ...
        rituals_img: [null, null, null, null, null, null, null, null],
        rituals_name: [`Abhisheka`, `Rudra Abhishek`, `Arati`, `Offerings`, `Bhajan`, `Jaya Mangala Arati`, `Ulagi`, `Abakasha`],
        about_rituals: [`The deity is ritually bathed with water, milk, and sandalwood paste (chandan), accompanied by the recitation of sacred hymns and the melodious ringing of temple bells, creating an atmosphere of devotion and reverence. This sacred cleansing ritual is believed to purify and sanctify the deity, inviting divine blessings upon the devotees present.`,
          `Devotees also perform Rudra Abhishek, a special worship of Lord Shiva, believed to invoke divine blessings and fulfill wishes`,
          `The ceremonial waving of lights is a common practice, creating an atmosphere of reverence and spirituality. `,
          `Devotees offer flowers, fruits, and prayers, expressing their devotion and gratitude. `,
          `Devotional songs enhance the devotee's spiritual experience. `,
          `The most important ritual in the early morning is Jaya Mangala Arati, which includes Arati in camphor (Karpur Alati) and a lamp with 7 wicks for each deity (Gota Alati). `,
          `After Jaya Mangala Arati, the dresses and floral decorations of the deities are removed, and they are dressed in white attire. `,
          `This is the morning ablution of the deities, including cleaning their teeth and tongue. `
        ],
        festivals: [
          {
            ...
            description: [`The Chaitra Mela is the most important festival celebrated at the Baba Chandaneswar Temple in Kendrapara during the month of Chaitra (March–April). This grand event draws thousands of devotees from Odisha and neighboring West Bengal. Many devotees observe a 14-day long fast leading up to the festival, offering prayers and performing rituals to seek Lord Shiva's blessings. The celebrations include sacred rituals, elaborate processions, and vibrant cultural programs, making it one of the most spiritually significant and festive occasions in the region.`,
              ...
              `On the full moon day of the Kartik month (October–November), devotees illuminate the temple with countless lamps (Deepa Daan) and offer special prayers, seeking prosperity, spiritual upliftment, and the removal of negativity from their lives.`,
              `Devotees, clad in saffron robes, walk barefoot while carrying sacred water from rivers to offer at the temple, all the while chanting “Bol Bom, Bol Bom” in deep devotion to Lord Shiva.`
            ],
          }
        ],
        calender: [
      ...
      {
        id: 203,
        name: "Sri Sri Lakshmi Varaha Swamy Temple ",
        location: "KENDRAPADA,ODISHA,INDIA",
        latitude: 21.628367607479504,
        longitude: 87.45780499430089,
        temple: "yes",
        ...
        shakti_pitha: "no",
        west: "yes",
        image: "/kendrapada-img/lakshmi-varah-jew-2.jpg",
        image_arr: ["/kendrapada-img/lakshmi-varah-jew-2.jpg", '/kendrapada-img/lakshmi-varah-jew.jpg', '/kendrapada-img/lakshmi-varah-jew-3.jpg', '/kendrapada-img/lakshmi-varah-jew-4.jpg'],
        ...
        rituals_img: [null, null, null, null],
        rituals_name: [``,],
        about_rituals: [
        ],
        festivals: [
      ...
      },
      {
        ...
        location: "MARSAGHAI, KENDRAPARA,ODISHA",
        latitude: 21.628367607479504,
        longitude: 87.45780499430089,
        temple: "yes",
        heritage_sites: "no",
...

  {
    ...
    products: [
      ...
      },
      {
        ...
        price: "$999",
        details: `Maa Vatarika Temple, located in the Kendrapara district of Odisha, is an ancient and sacred temple dedicated to Goddess Vatarika, a form of the Divine Mother worshipped for her protection and blessings. The temple is a significant pilgrimage site in the region and attracts numerous devotees, especially during major Hindu festivals like Durga Puja and Maha Shivaratri. People visit the temple to seek the goddess's blessings for peace, prosperity, and well-being.
      ...
      },
      {
        ...
        image_arr: ["/shaktipitha-img/Charchika-Temple.jpg"],
      ...
      },
      {
        ...
        about_rituals: [`The temple doors would be opened in the early morning, followed by the cleaning of the temple premises and the idols of Lord Shiva, Lord Rama, and Maa Dakshina Kali.`,
          `An auspicious morning ritual involving the waving of lamps (deepa) before the deities, accompanied by prayers and chanting.`,
          `The sacred bathing of the Shiva Linga with water, milk, ghee, honey, and other ritualistic substances is a fundamental practice in Shiva temples and would certainly be performed at Singhanath Temple.`,
          `Priests would conduct daily prayers (puja) offering flowers, incense, and possibly cooked food (bhoga) to all the deities within the temple complex – Lord Shiva, Lord Rama, and Maa Dakshina Kali. The offerings might vary depending on the deity and the time of day.`,
          `An evening ritual similar to the morning aarti, involving lamps, prayers, and devotional singing.`,
          `The temple doors would be closed at the end of the day after the final prayers and rituals are completed.`
        ],
        festivals: [
          {
            name: [ `Mahashivaratri`,`Makar Sankranti`,`Kartik Purnima`],
            img: [ ],
            description: [ ` This is a major festival dedicated to Lord Shiva, the presiding deity of the temple. It attracts a large number of devotees for special prayers and rituals.`,
              `This harvest festival is also significantly celebrated at Singhanath Temple, often drawing large crowds.`,
              ` The full moon day in the month of Kartik is considered auspicious and is celebrated at the temple.`
            ],
          }
        ],
        calender: [
        ...
        festivals: [
          {
            ...
            img: [ ],
            description: [ `The temple priests and servitors would open the main doors of the temple.This is often accompanied by chanting of mantras and ringing of bells to awaken the deities.`,
              `An auspicious ritual where lamps (deepa) are waved before the idols of Lord Madhava and the accompanying deities (Durga, Lakshmi, Saraswati, Bhagwati, Hanuman, Buddha, and Navagraha).Hymns and prayers dedicated to the deities are recited.Incense is often offered during the aarti.`,
              `The idols, especially Lord Madhava, are ritually bathed.The bathing may involve the use of water, milk, curd, ghee, honey, sugar (Panchamrita), and fragrant substances.Mantras are chanted during the abhisheka.The deities are then cleaned and dressed in fresh attire`,
              `Cooked food (bhoga) is offered to the deities. This typically includes rice, dal, curries, and sweets prepared in the temple kitchen according to specific guidelines.The offerings are made with specific rituals and prayers.After the offering, the bhoga is considered Mahaprasad (blessed food) and is later distributed to devotees.`,
              `A second offering of cooked food is made to the deities, similar to the morning offering but potentially with different dishes.This is followed by a period of rest for the deities (Madhyanha Pahuda in some major temples, though the extent of this at Madhava Temple isn't specified).`,
              `A second aarti ritual is performed in the evening, similar to the morning aarti with lamps, prayers, and incense.`,
              `A final offering of food is made to the deities before they are put to rest. This might be a lighter meal.`,
              `The deities are prepared for the night. This may involve changing their attire and adorning them with flowers.Hymns appropriate for putting the deities to rest are sung.The temple doors are closed for the night.`
            ],
          }
        ],
        calender: [
    ...
    products: [
      {
        ...
        shakti_pitha: "no",
        image: "/nayagarh-img/nilamadhav temple.jpg",
        image_arr: ["/nayagarh-img/lord-nilamadhab.jpg", "/nayagarh-img/kantilo-nilamadhab.jpg"],
        ...
        rituals_img: [],
        rituals_name: [`Morning`, `Prayer and Worship`, `Offering of Food`, `Evening`],
        about_rituals: [`Each morning, the sacred day begins with the divine ritual of bathing Lord Nilamadhav. The idol is gently cleansed with pure, holy water, symbolizing spiritual purification. After the sacred bath, the deity is gracefully adorned with fresh, fragrant flowers and exquisite ornaments, enhancing the divine aura. Every petal and every jewel reflects the devotion and reverence of the worshippers, as they prepare the Lord to bless the day with his serene presence.`,
          `As the morning rituals continue, melodious prayers and sacred hymns are recited with deep devotion, filling the temple with a serene and spiritual energy. Lord Nilamadhav is then reverently offered a variety of auspicious items — vibrant garlands woven from fresh flowers, the soothing fragrance of burning incense, and delicate floral offerings — each symbolizing the pure love and unwavering faith of the devotees.`,
          `As part of the sacred offerings, an array of pure and delicious foods is lovingly presented before Lord Nilamadhav. The offerings include an assortment of traditional sweets, ripe and fragrant fruits, and a variety of freshly prepared vegetarian dishes. Each item is chosen with devotion and care, symbolizing gratitude and a humble plea for divine blessings.`,
          `As the golden hues of sunset bathe the temple in a serene glow, a sacred lamp is lit before Lord Nilamadhav, symbolizing the dispelling of darkness and the welcoming of divine grace. Devotees gather once again to offer heartfelt prayers and hymns, mirroring the devotion of the morning rituals. The soft flicker of the lamp, accompanied by the soothing chants, creates an atmosphere of deep peace and spiritual fulfillment.`
        ],
        festivals: [
          {
      ...
      },
      {
        ...
        rituals_img: ["/nayagarh-img/ladukeswara-4.jpg", "/nayagarh-img/ladukeswara.jpg"],
        ...
        festivals: [
          {
            ...
            img: [null, null, null, null, null, null, null, "/nayagarh-img/danda-nacha.webp"],
    ...
    products: [
      {
        ...
        history: [
          {
            name: ['Legendary Origin', 'Ancient Age'],
            img: ["/bhubaneswar-img/ancient-image-lingaraj.jpg", null],
      ...
      },
      {
        ...
        about_rituals: [`At the Kapileswar Temple in Bhubaneswar, the day begins with a serene and devotional morning Aarti performed in front of the Shiva Lingam, the presiding deity of the temple. The sound of bells ringing and the chanting of sacred hymns fill the air, creating a spiritually uplifting atmosphere. The Aarti is a significant ritual that sets the tone for the day, as devotees gather to offer their prayers and seek blessings from Lord Shiva.
                         Following the Aarti, a series of rituals are carried out to honor the deity. The Shiva Lingam is carefully cleaned and bathed with water, milk, and other sacred offerings, symbolizing purification and devotion. The temple priests then adorn the deity with fresh flowers and traditional ornaments, enhancing the divine presence of Lord Shiva. These rituals are performed with utmost reverence, ensuring that the temple and the deity are prepared for the day ahead.
                         This combination of Aarti, cleaning, and adorning the deity creates a peaceful and sacred environment, drawing devotees into a deeper connection with the divine and setting the spiritual tone for the rest of the day at Kapileswar Temple.`,
                         `The evening Aarti at Kapileswar Temple is a significant and revered ritual that marks the transition from day to night with divine reverence. As the sun sets, the temple is beautifully illuminated by the soft glow of oil lamps, which are carefully arranged around the temple premises, casting a warm and peaceful light. The flickering flames create an enchanting atmosphere, heightening the spiritual ambiance and enveloping the temple in a serene glow.
                         During this time, devotees gather to participate in the Aarti, singing hymns and chanting prayers dedicated to Lord Shiva. The rhythmic sounds of bells, along with the chants, fill the air, creating a spiritually charged environment. The priests perform the Aarti with great devotion, waving the oil lamps in a circular motion before the Shiva Lingam, symbolizing the dispelling of darkness and the welcoming of divine light into the hearts of devotees.
                         The evening Aarti at Kapileswar Temple is not only a ritual of worship but also a moment for devotees to reflect, meditate, and connect with the divine. The soft light from the lamps, coupled with the chanting and prayers, creates a profound sense of peace and tranquility, leaving worshippers with a deep sense of fulfillment as they conclude their day in devotion.`,
                         `At Kapileswar Temple, devotees actively participate in a range of devotional activities during their visit, engaging in the timeless practices of chanting, prayers, and offering flowers, incense, and other sacred items. Upon entering the temple, devotees often begin by chanting sacred mantras, such as "Om Namah Shivaya," in unison or individually, invoking Lord Shiva's blessings for peace, prosperity, and spiritual growth. The rhythmic chanting creates an atmosphere of spiritual unity and devotion, drawing the worshippers deeper into their connection with the divine.
                         Devotees also offer flowers as a symbol of purity, beauty, and reverence, placing them at the feet of the Shiva Lingam. The act of offering flowers represents the devotee’s love and devotion, surrendering the natural beauty of creation to the Creator. Incense sticks are lit and offered as part of the ritual, filling the temple with a pleasant fragrance that is believed to purify the space and heighten the spiritual energy during the prayers. The devotees may also present other offerings such as fruits, sweets, and milk, symbolizing their gratitude and devotion.
                         As part of the sacred practices, the atmosphere is further enriched with the sound of bells, hymns, and devotional songs, creating a peaceful and reverent ambiance. Every offering made, whether it be flowers, incense, or prayers, is seen as a humble gesture of respect and devotion to Lord Shiva, fostering a deep spiritual connection between the devotee and the divine.`,
      ...
      },
      {
        ...
        image_arr: ["/bhubaneswar-img/parsurameswar-temple.jpg"],
      ...
      },
      {
        ...
        image_arr: ["/bhubaneswar-img/brahmeswar-temple.jpg"],
        ...
        rituals_img: [],
        rituals_name: [`Tantric Traditions`, `Devadasi Tradition`, ],
        about_rituals: [`The Brahmeswar Temple in Bhubaneswar is renowned for its deep connection to tantric traditions and rituals, making it a unique spiritual and architectural landmark. Built during the 9th century, the temple is an excellent example of the rich cultural and spiritual heritage of Odisha, with strong influences from tantric practices that have been intricately woven into the temple's design and religious observances.
                        The temple is known for its depictions of fierce deities, such as Chamunda, a terrifying form of the goddess Durga associated with destruction and the removal of evil. These images are integral to the temple’s artistic and spiritual character, showcasing the influence of tantric philosophies, which often emphasize the worship of powerful and formidable deities. The carvings and sculptures found in and around the temple are evidence of the tantric iconography and the temple’s connection to esoteric practices that focus on invoking divine energies for protection, spiritual growth, and the destruction of negative forces.`,
                        `The Devadasi tradition at Brahmeswar Temple in Bhubaneswar was an integral aspect of the temple's religious and cultural practices. The tradition involved dedicating women to the service of the temple deity, who, in this case, was likely Lord Shiva or one of his fierce forms, as represented in the temple's iconography. These women, known as Devadasis (literally "servants of the deity"), played a vital role in the temple’s worship and religious ceremonies, contributing significantly to the spiritual ambiance and ritualistic practices of the temple.`],

        festivals: [
          {
            name: [`Mahashivaratri`, `Kartik Purnima`, `Ganesh Puja`, `Saraswati Puja`, `Lakshmi Puja`, `Kali Puja`],
            img: [null, "/bhubaneswar-img/Kartika-Purnima.jpg"],
            description: [`Maha Shivaratri at Brahmeswar Temple in Bhubaneswar is a grand and spiritually enriching celebration dedicated to Lord Shiva. Held on the 14th day of the dark fortnight in the month of Phalguna, it involves special rituals such as Shiva Abhishekam, night-long vigils with chanting of mantras like "Om Namah Shivaya," and offerings of flowers, fruits, and milk to the Shiva Linga. Devotees observe fasting, participate in cultural events like Odissi dance and devotional music, and light oil lamps to symbolize the triumph of light over darkness. The temple, known for its historical and architectural significance, becomes a hub of devotion and spiritual awakening, drawing pilgrims seeking blessings for peace, strength, and liberation.`,
                          `Kartik Purnima is celebrated on the full moon day of the month of Kartika (October-November) in the Hindu lunar calendar. This day is considered highly auspicious, as it marks the end of the holy month of Kartika and is dedicated to Lord Shiva. At Brahmeswar Temple, Kartik Purnima is observed with great reverence and devotion. The temple is beautifully decorated with lights, and thousands of devotees visit to offer prayers and perform rituals. The day is marked by special Shiva pujas, including the lighting of diyas (oil lamps), which are believed to bring peace and prosperity. Devotees also perform the Kartik Snana (holy bath) in nearby water bodies, and many fast throughout the day. The night is filled with chanting and prayer services, and the temple premises are lit up with lamps, creating a mesmerizing spiritual atmosphere.`,
                          `Ganesh Puja, also known as Ganesh Chaturthi, is a festival dedicated to Lord Ganesha, the remover of obstacles and the god of wisdom and prosperity. Celebrated during the month of Bhadrapada (August–September), it is a major festival in Brahmeswar Temple. The temple is beautifully decorated with flowers, and a grand idol of Lord Ganesha is placed in the temple for worship. Devotees from all over the city gather to offer prayers, sweets, and flowers, seeking Lord Ganesha's blessings for success, wealth, and the removal of obstacles. The temple priests perform elaborate rituals, including chanting mantras, offering Modaks (Lord Ganesha's favorite sweet), and conducting the Ganesh Aarti. The atmosphere is filled with the rhythmic beats of drums and devotional songs, creating a vibrant and spiritually uplifting environment. The festival lasts for several days, and on the final day, a grand procession is carried out, where the idol is taken to a nearby water body for immersion.`,
                          `At Brahmeswar Temple, Saraswati Puja is celebrated with deep reverence, as the temple has a long-standing tradition of honoring the goddess. On this day, the temple is beautifully decorated with flowers, and a grand idol of Goddess Saraswati is placed for worship. The atmosphere is filled with devotion as devotees, particularly students and scholars, flock to the temple to seek the goddess’s blessings for wisdom, knowledge, and success in their academic pursuits.`,
                          `Lakshmi Puja is an important and vibrant festival celebrated with great devotion at Brahmeswar Temple in Bhubaneswar, dedicated to Goddess Lakshmi, the goddess of wealth, prosperity, and well-being. This festival is usually observed during the auspicious time of Diwali, which falls on the 15th day of the dark fortnight (Ashvin Amavasya) in the Hindu lunar month of Ashvin (October-November).At Brahmeswar Temple, Lakshmi Puja is celebrated with immense fervor, marking the triumph of light over darkness and good over evil. While Diwali is widely known for its festive lighting and joy, at Brahmeswar Temple, it holds a more profound spiritual significance. The temple is beautifully adorned with thousands of diyas (oil lamps), creating a mesmerizing sight, as devotees gather to honor Goddess Lakshmi and seek her blessings for wealth, prosperity, and overall well-being.`,
                          `Kali Puja is a significant and powerful festival dedicated to Goddess Kali, the fierce and protective form of the Divine Mother, celebrated with great devotion at Brahmeswar Temple in Bhubaneswar. Kali Puja typically falls on the same day as Diwali, during the dark fortnight of the Ashvin month (October-November), coinciding with the night of the new moon, known as Kali Amavasya.At Brahmeswar Temple, Kali Puja is celebrated with profound spiritual significance and intensity. The temple, known for its rich history and cultural heritage, becomes a center of fervent devotion during the festival. Goddess Kali is worshipped for her power to destroy evil, remove darkness, and bring spiritual liberation. Her worship at Brahmeswar Temple is a reflection of the region's deep reverence for the goddess and the role she plays in dispelling ignorance and negativity.`
            ],
          }
        ],
        calender: [
...

      {
        ...
        image_arr: ["/shaktipitha-img/maa-bhagabati.jpg", "/bhubaneswar-img/maa-bhagabati-temple.jpg"],
        ...
        festivals: [
          {
            name: [`Chapa Khela`, `Dussehra`],
            img: ["/bhubaneswar-img/chapakhela.webp", "/bhubaneswar-img/maa-bhagabati.jpg"],
            description: [`Chapa Khela is an important and vibrant ritualistic event celebrated at the Maa Bhagabati Temple in Bhubaneswar, Odisha. It is a traditional festival that holds immense cultural and religious significance, especially among the devotees of Goddess Bhagabati. The term "Chapa" refers to a type of game or playful ritual that involves devotion, and Khela means play or game in Odia. Together, "Chapa Khela" signifies a ceremonial event that blends religious devotion with festive exuberance.Chapa Khela is typically observed during special festivals, particularly those dedicated to Goddess Bhagabati or during auspicious days in the temple calendar, such as Navratri or Durga Puja. During this event, devotees engage in a series of devotional games and playful activities, which are believed to be offerings to the goddess. The ritual is not only a form of worship but also a way to invoke divine blessings in a joyous and communal setting.`,
                           `Dussehra, also known as Vijayadashami, is one of the most important and grandly celebrated festivals at the Maa Bhagabati Temple in Bhubaneswar, Odisha. The festival, which marks the victory of good over evil, is observed with great devotion and enthusiasm at the temple, drawing large numbers of devotees from across the region. In the temple, Dussehra is not only a time to celebrate the triumph of Lord Rama over Ravana, but it also holds special significance in the worship of Goddess Bhagabati, a powerful form of Shakti.At Maa Bhagabati Temple, Dussehra is a celebration of the divine feminine energy symbolized by Goddess Bhagabati, who is worshipped as a fierce and protective deity. This festival is believed to represent the victory of divine forces over demonic forces, as depicted in the legend of Rama's victory over Ravana in the Ramayana. However, at the Maa Bhagabati Temple, the festival also emphasizes the empowerment of the goddess and her role in removing evil, restoring righteousness, and offering strength and protection to her devotees.`
            ],
          }
        ],
        calender: [
      ...
      },
      {
        ...
        image_arr: ["/bhubaneswar-img/Kedar_Gouri_Temple.jpg", "/bhubaneswar-img/kedargauri-temple.jpg"],
        description: "Gauri Temple, a revered Shakti Pitha in Bhubaneswar, Odisha, is dedicated to Goddess Gauri. Known for its Kalinga architecture, intricate carvings, and spiritual significance, it attracts devotees, especially during Durga Puja and Navaratri festivals.",
        price: "$999",
        details: `Gauri Temple, a significant Shakti Pitha in Bhubaneswar, Odisha, is dedicated to Goddess Gauri, an incarnation of Shakti. This ancient temple showcases Kalinga-style architecture, featuring intricate carvings and exquisite sculptures. It holds immense religious significance and is a center of devotion for devotees, particularly during Durga Puja and Navaratri.
...

  {
    ...
    products: [

      {
        ...
        rituals_img: ["/jajapur-img/mangal-arti.jpg", null, null, null, null, null, null, null, null],
    ...
    products: [
      {
        ...
        rituals_img: [null,null,null,null,null,null,null,null,null],
        ...
        about_rituals: [` The Majana of Maa Hingula is performed twice a day, once in the morning before sunrise and again in the evening. Each Majana lasts for about one hour.
                        ...
                        `After the Bal-Bhog, the Kanika Bhog is offered to the deities. Once the offering is completed, the Kanika Bhog is made available to the devotees, allowing them to receive the blessed food as a sacred token of the deity's grace`,
                        `Madhyahna Bhog is offered to the deities around midday. The offerings include Rice, Dalma, Khir, Curry, and Khata (a sour dish), along with other traditional items. These offerings are made available to the public upon special request.`,
                        `The temple observes a rest period for the deities during the daytime, from 1:00 P.M. to 4:00 P.M.. However, on special occasions such as Sankranti, Hingula Yatra, and other festivals, the temple remains open until midnight, and only the night pahada (night vigil) is observed during these events.`,
                        `The Temple is reopened at 4:00 PM`,
                        `Again in the evening majana of deities is performed. The same procedure is repeated in this event as in the morning Majana and the deities are made ready for sandhya Alati at 6.30 PM.`,
                        `After the evening Majana Sandhya Alati of the dieties are performed. Pana Bhog made up of Banana, Sweets and ladoo etc.In this event the dieties are worshipped with incense sticks and deepa`,
                        `After two hours of the sandhya Alati the deities go for ratri(Night) Pahada. The temple remains closed during this time`
      ...
      },
      {
        ...
        about_rituals: [`: As dawn breaks, the temple doors are ceremonially opened, allowing devotees to enter and have the first darshan (sight) of the deities for the day. This is often accompanied by the ringing of bells and blowing of conch shells, creating an auspicious atmosphere.`,
          `This is the first arati (waving of lamps) performed to the deities. Priests offer lit lamps, often accompanied by chanting of prayers and devotional hymns. The gentle glow of the lamps illuminates the faces of Lord Jagannath, Balabhadra, Subhadra, and Sudarshan, considered a very auspicious sight.`,
          `Following the Mangal Arati, the priests carefully remove the clothing and decorations that the deities wore the previous night. This is a private ritual, not usually witnessed by the public.`,
          ` This ritual symbolizes the morning ablutions of the deities. While not a literal washing and brushing in human terms, it involves symbolic cleaning with specific materials and prayers, signifying purification for the day ahead.`,
          ` After the Abakash, the deities are adorned in fresh sets of clothing and new decorations for the day. The type of attire can vary based on the day of the week or any special occasions. This dressing ritual is often elaborate and beautiful to witness (though some parts might be private).`,
          `This is the first food offering of the day, typically consisting of light refreshments like fruits, sweets, and curd. It's considered the deities' breakfast.`,
          `This is a more substantial cooked meal offered to the deities in the morning. It usually includes rice, lentils (dal), vegetables, and other traditional Odia dishes prepared with specific ingredients and following strict guidelines.`,
          ` While the main midday offering to the deities inside the sanctum is the Madhyanha Dhupa, the Bhoga Mandap in Puri (and likely replicated in Saila Srikhetra) is where a variety of food items are offered for devotees to partake as mahaprasad (consecrated food). This might involve a separate offering ceremony.`,
          `This is the main meal offering of the day, similar in composition to the Sakala Dhupa but potentially with different dishes. It's a significant part of the daily ritual. Following this offering, the food becomes Mahaprasad.`,
          ` After the midday rituals, the temple doors might be closed for a brief period, allowing the deities to symbolically rest.`,
          `Similar to the Mangal Arati, this involves the waving of lamps before the deities in the evening, accompanied by prayers and hymns. The atmosphere is often filled with devotion and the fragrance of incense.`,
          ` Another cooked meal is offered to the deities in the evening.`,
          `On specific days or during particular festivals, a paste made of sandalwood is applied to the bodies of the deities. This is considered cooling and auspicious.`,
          ` Before the deities are put to rest, they are dressed in special night attire, usually simpler and more comfortable.`,
          ` A final, light offering of food is made before the deities retire for the night. This often includes sweets and পান (paan - betel leaves).`,
          `This is the final ritual of the day, where the deities are symbolically put to sleep. Prayers are chanted, and the temple doors are closed for the night, signifying the end of the daily cycle of worship.`,
        ],
        festivals:[
          {
      ...
      },
      {
        ...
        chari_khetra: "no",
        shakti_pitha: "no",
        image: "/anugul-img/RAMACHANDI-TEMPLE-KOSOLACHHENDIPADAANGUL.webp",
        image_arr: ["/anugul-img/RAMACHANDI-TEMPLE-KOSOLACHHENDIPADAANGUL.webp", "/anugul-img/RAMCHANDI-TEMPLE-KOSALA-CHHENDIPADA-ANGUL1.webp","/anugul-img/ramchndi angul.jfif"],
        description: "This renowned Hindu temple is dedicated to Lord Jagannath, Lord Balabhadra, Devi Subhadra, and Sudarshan...",
        price: "$999",
        ...
        about_rituals: [` The temple doors would be opened early in the morning by the priests, often accompanied by the ringing of bells and chanting of morning prayers.`,
          `The first alati (waving of lamps) of the day is performed before the deity, Goddess Ramachandi. This is a symbolic awakening and welcoming of the goddess.`,
          ` The idol of Goddess Ramachandi would likely be bathed with water and possibly other sacred substances like milk, ghee, honey, or fruit juices, accompanied by the chanting of mantras.`,
          `After the bath, the goddess is dressed in fresh attire and adorned with flowers, jewelry, and other traditional ornaments. The specific attire and adornments might vary depending on the day and local customs.`,
          ` A more elaborate morning puja would be performed, involving the offering of flowers (hibiscus is often significant for goddesses), incense, lamps (diyas), and sometimes food offerings (like fruits or simple sweets). Mantras dedicated to Goddess Durga or her various forms would be recited.`,
          ` The temple would be open for devotees to have darshan and offer their personal prayers.`,
          ` A midday meal (bhog) would be prepared and offered to the goddess. This typically includes cooked rice, lentils, vegetables, and other traditional Odia dishes. After being offered, this food is often distributed to devotees as prasad (blessed food).`,
          `Some temples might have a brief period in the afternoon when the inner sanctum is closed for a symbolic rest of the deity.`,
          `As dusk approaches, another alati is performed. This is a significant ritual, often accompanied by devotional songs (bhajans) and the ringing of bells.`,
          `A shorter evening puja might be conducted.`,
          ` Devotees continue to visit for darshan.`,
          ` The goddess might be dressed in simpler attire for the night.`,
          `Before closing the temple doors, a final prayer or ritual might be performed to symbolically put the deity to rest for the night.`
        ],
        festivals:[
          {
...

  {
    ...
    products: [
      ...
      },
      {
        ...
        rituals_img: [null,null,null,null,null,null,null,null,null,null,null],
        ...
        about_rituals: [`This is the first ritual of the day, involving the changing of the deities' night clothes. Specially appointed servitors perform this duty. After removing the night attire, the deities are dressed in fresh clothes for their morning activities.`,
          ` This ritual involves the brushing of teeth and bathing of the deities. Servitors use brass mirrors to symbolically perform these actions, offering water mixed with fragrant ingredients.`,
          `Following the bath, the deities are dressed in another set of clean clothes. The color of the attire changes daily, corresponding to the day of the week.`,
          ` During this time, the public is allowed to have a darshan (viewing) of the deities. However, touching the idols is usually not permitted.`,
          `After Sahanamela, the deities are adorned with specific colored clothing for the day and various gold ornaments embedded with precious stones. They are also decorated with fragrant flower ornaments.`,
          `This involves offering oblations to the sacred fire in the temple kitchen. The fire used for cooking the Lord's meals is kindled from this sacred fire.`,
          ` This is the breakfast offering to the deities, consisting of light food items like khai (parched rice), kora (a sweet), khua laddu, and fruits. Betel leaves (pana), considered a favorite of the Lord, are also offered.`,
          `A large variety of cooked food, including rice, dal, vegetable curries, and cakes, are offered to the deities in the Bhoga Mandap, a hall located behind the Garuda pillar.`,
          `This is the midday meal offering. After the puja (worship), a portion of the offered food is re-offered to Goddess Bimala.`,
          `In the evening, the deities' clothes are changed again (Mailam). If time permits, there might be another Sahanamela for public viewing. Chandanalagi involves applying sandalwood paste mixed with camphor, kasturi (musk), and kesar (saffron) on the deities' bodies to cool them.`,
          `This is the final ritual of the day, where the deities are put to rest for the night.`,
        ],
        festivals:[
          {
    ...
    products: [
      {
        ...
        rituals_img: [null,null,null,null,null],
        rituals_name: [`Abhishekam`,`Puja`,`Naivedyam`,`Aarti`,`Darshan`],
        about_rituals: [`A sacred bath of the Shiva Lingam with water, milk, ghee, honey, and other sacred substances. This is a common daily ritual in Shiva temples.`,
          `Offering of flowers, incense, lamps (Aarti), and bilva leaves (considered sacred to Lord Shiva).`,
          `Offering of food to the deity. This might be a simple offering in the morning and a more elaborate one at other times of the day.`,
          ` Waving of lamps before the deity, accompanied by chanting and prayers, typically performed in the morning and evening.`,
          `The temple would likely have নির্দিষ্ট times when devotees can visit and have a view of the deity.`
        ],
        festivals:[
          {
            name:[`Maha Shivaratri`],
            img:[],
            description:[`This is the most significant festival dedicated to Lord Shiva and draws a large number of devotees to the temple annually. Thousands of people visit the Mallikeswara Temple on this auspicious occasion to offer prayers and participate in the special rituals and celebrations organized throughout the day and night.`],
          }
        ],
        calender: [
          {
    ...
    products: [
      {
        ...
        rituals_img: [null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,],
        ...
        about_rituals: [` Imagine the pre-dawn stillness. The Palia Puspalaka (one of the temple servants) arrives to check the seal placed on the inner sanctum doors the previous night. Once verified, the doors are slowly and reverently opened. The sounds of conch shells being blown and the initial chanting of hymns begin to permeate the air, stirring the temple from its nightly slumber.`,
          ...
          `Following the Abakash, the deities are dressed again, often in another set of fresh clothes. This signifies their readiness for the day's activities and interactions with devotees. The Akhanda Baitha (uninterrupted lamp) is also carefully tended to, ensuring its continuous flame.`,
          ` This is a cherished time for devotees. For a specific period, the general public is allowed to step onto the Ratnavedi (the bejeweled platform where the deities reside) and have a close and personal darshan. This opportunity allows for intimate prayers and a profound connection with the divine. The atmosphere is often filled with quiet reverence and the murmur of prayers.`,
          ...
          `A sacred fire ritual is performed in the temple kitchen (Rosha Ghara) to purify the environment and the food that will be offered.`,
          ` Prayers and offerings are made to Lord Surya (the Sun God), acknowledging his vital role in the cosmos.`,
          `The gatekeepers of the temple, Jaya and Vijaya, are also worshipped, seeking their permission for the day's activities and the entry of devotees.`,
          ...
          ` Later in the day, a larger communal offering of food is made in the Bhoga Mandap. This food, after being sanctified by the deities, becomes the sacred Mahaprasad, which is then distributed to devotees. The sharing and consumption of Mahaprasad are considered highly auspicious and foster a sense of unity.`,
          ` Another substantial meal is offered around midday, often with a different selection of curries and sweets.`,
          ` For a brief period, the deities are symbolically put to rest. The curtains of the inner sanctum might be drawn, signifying their repose.`,
          ` As the day begins to fade, the evening alati is performed, similar to the morning one but with its own set of hymns and musical accompaniment. The temple is often illuminated with lamps, creating a serene atmosphere.`,
          `he evening meal is offered, typically consisting of lighter fare compared to the morning and afternoon offerings.`,
          ` Following the evening meal, a specific alati called Jaya Mangala Alati is performed, signifying auspiciousness and victory.`,
          ` Depending on the season and specific days, a cooling paste of sandalwood, often mixed with fragrant oils and herbs, is applied to the deities' bodies. This is particularly prevalent during the hotter months.`,
          `As the day draws to a close, the deities are dressed in their final attire for the night. This Besa is often made of soft fabrics and adorned with fragrant flowers. In Puri, the recitation of verses from the Gita Govinda during this time adds a devotional and romantic element.`,
          `The last offering of the day is a light supper, often consisting of Pakhala (watered rice), curd, and simple sweets.`,
          ` Symbolic beds are arranged for the deities within the sanctum, signifying their rest for the night.`,
          `Finally, after the night offering and prayers, the temple doors are closed, and the deities are symbolically put to sleep, concluding the day's elaborate cycle of care and devotion.`
        ],
...

      {
        ...
        about_rituals: [`The temple would typically open early in the morning, often before sunrise. Temple servitors (priests and attendants) would clean the temple premises, including the sanctum sanctorum (garbhagriha) where the main deity resides.`,
                        `The idol of Goddess Kichakeswari would likely be bathed with sacred substances. These can include water, milk, ghee (clarified butter), honey, curd, and fruit juices. The specific items used might vary depending on the day or special occasions.`,
                        `After the abhishekam, the deity would be adorned with beautiful clothes, jewelry, flowers, and other decorative items. This process is crucial as it prepares the Goddess for darshan (viewing) by the devotees.`,
                        `The first aarti (waving of lamps) of the day is performed in the morning. This involves offering light to the deity along with the chanting of prayers and hymns.`,
                        ` Throughout the day, various pujas (worship ceremonies) would be conducted by the priests. Devotees might also bring their offerings, such as flowers, fruits, sweets, and other items, which are offered to the Goddess.`,
                        `A midday aarti might be performed.`,
                        `As evening approaches, another significant aarti is performed. This is often a well-attended ritual.`,
                        ` Food offerings (bhoga) are made to the deity at specific times during the day. This consecrated food is later distributed to the devotees as prasad. The type of bhoga offered can vary.`,
                        ` Priests would continuously or at specific times recite sacred mantras and hymns dedicated to Goddess Kichakeswari.`,
                        `The temple would have specific timings when devotees can have darshan of the deity. These timings might have breaks for the rituals and bhoga offerings.`,
                        ` The temple would close for the night after the final rituals and aarti.`,
        ],
        festivals:[
          {
            name:[`Durga Puja and Navaratri`,`Maha Shivaratri`,],
            img:[],
            description:[`his is a significant festival celebrated with great fervor. As Kichakeswari is an aspect of Goddess Durga/Kali/Chamunda, Navaratri (both the one in Ashwin/September-October and Chaitra/March-April) is a major observance. During this time, special pujas, rituals, and cultural programs are likely held. The triumph of Goddess Durga over Mahishasura is a key theme.`,
              ` Interestingly, despite being a temple primarily dedicated to a goddess, Maha Shivaratri ("The Great Night of Shiva") is mentioned as a major festival in Khiching. This could be due to the presence of Shiva lingams of seven ancient temples in the vicinity, or the general reverence for Lord Shiva in the region. The festival is celebrated over seven days in Khiching.`
            ],
          }
        ],
        calender: [
...

  {
    ...
    products: [

      {
        ...
        price: "$999",
        details: `Akhandalamani Temple, located in the Jagatsinghpur district of Odisha, India, is a revered Hindu pilgrimage site dedicated to Lord Shiva. Situated on the banks of the Kharasrota River, the temple is famous for housing the idol of Akhandalamani, a unique form of Lord Shiva. The name "Akhandalamani" signifies the "unbroken light" of the deity, symbolizing the eternal presence of divine energy.
        ...
        festivals: [
          {
            ...
            img: ["/rayagada-img/chaitra-parva.png"],
    ...
    products: [
      {
        ...
        shakti_pitha: "no",
        image: "/nuapada-img/Yogeswar Temple.jpg",
        image_arr: ["/nuapada-img/Yogeswar Temple.jpg", "/nuapada-img/Yogeswar Temple 1.jpg", "/nuapada-img/jogeswar-2.jpg", "/nuapada-img/jogeswar-3.png", "/nuapada-img/jogeswar-4.png", "/nuapada-img/jogeswar-5.png", "/nuapada-img/jogeswar-2.jpg", "/nuapada-img/jogeswar-6.jpg", "/nuapada-img/jogeswar-7.jpg", "/nuapada-img/jogeswar-8.jpg"],
    ...
    products: [
      {
        ...
        rituals_img: ["/subarnpur-img/mangala-aarti.jpg", "/subarnpur-img/abhisek.jpg", "/subarnpur-img/sandhya-aarti.jpg"],
        rituals_name: [`Morning Aarti (Mangala Aarti)`, `Abhishek`, `Evening Aarti`],
      ...
      },
      {
        ...
        rituals_img: [null, null],
        rituals_name: [`Mangala Aarti`, `Abhisheka`, `Dhupa and Deepa`, `Chanting of Mantras`],
        about_rituals: [`The day at the Pancharatha Temple in Sonepur begins with the sacred Mangala Aarti, a ritual that marks the awakening of the deity. As the temple doors open in the early hours, the atmosphere is filled with a sense of devotion and serenity. Priests light traditional oil lamps, illuminating the sanctum with a warm, divine glow. The air resonates with the chanting of hymns and mantras, invoking the presence of the divine and setting a spiritually charged tone for the day. This ritual symbolizes the beginning of a new day with divine blessings, drawing devotees into a moment of reflection, reverence, and connection with the deity. The Mangala Aarti serves not only as a ceremonial awakening of the idol but also as a spiritual awakening for all who witness it.`,
                        ...
                        `The Abhisheka ritual at the Pancharatha Temple in Sonepur, Odisha, is a profound expression of devotion and reverence, reflecting the temple's deep-rooted spiritual traditions. This ceremonial bathing of the deity is a daily practice, symbolizing purification and the renewal of divine energy.`,
                        `The Chanting of Mantras at the Pancharatha Temple in Subarnapur (Sonepur), Odisha, is a vital aspect of the temple’s daily and ceremonial rituals, creating an atmosphere filled with spiritual energy and devotion. The rhythmic recitation of Vedic mantras, particularly those dedicated to Lord Shiva and the Shakta tradition, resonates through the sanctum, invoking divine presence and purifying the surroundings. Priests and devotees together chant sacred texts like the Shiva Purana, Rudram, and other hymns associated with the deity, offering prayers for peace, prosperity, and spiritual upliftment.
                        This practice is not only a form of worship but also a means of meditation and inner cleansing. The sound vibrations of the mantras are believed to harmonize the body and mind, aligning the devotee with divine consciousness. At Pancharatha Temple, mantra chanting serves as a bridge between the material and the spiritual, enhancing the sanctity of the temple space.`
    ...
    products: [
      {
        ...
        rituals_img: [null, "/sundargarh-img/Jagannath-Temple.jpg", null, null, null, null, null, null, null, null, ],
        ...
        festivals: [
          {
            ...
            img: ["/boudh-img/charisambhu-temple.jpg", null, "/boudh-img/charisambhu-dandanacha.jpg", "/boudh-img/Charisambhu-Temple.webp"],
  ...
  //deogarh district
  {
    ...
    products: [
      ...
      },
      {
        ...
        adishakti_pitha: "no",
        saiva_khetra: "no",
        image: "/Deogarh-img/Katasar Ghat.jpg",
        image_arr: ["/Deogarh-img/katasr ghat deogarh.jpg","/Deogarh-img/katasar ghat image 4.jfif","/Deogarh-img/katasar ghat image 3.jfif","/Deogarh-img/katasar ghat  deogarh 2.jfif","/Deogarh-img/Katasar Ghat.jpg"],
        ...
        about_rituals: [`  The temple doors would likely be opened in the morning by the priests or caretakers. The temple premises and the idol of Goddess Banadurga would be cleaned.`,
          `An auspicious lamp would likely be offered to the Goddess in the morning.`,
          ` A basic puja (worship) would be performed, which might include offering flowers, incense, and perhaps some simple food offerings (bhoga).`,
          ` Depending on the temple's tradition and resources, there might be a midday offering of food.`,
          `As evening approaches, another lamp offering would likely take place.`,
          `The temple doors would be closed at night after a final brief ritual.`,
        ],
        festivals:[
              {
        name:[` Maha Shivaratri`,`Durga Puja`],
        img:[],
        description:[`  This is a major festival dedicated to Lord Shiva and is celebrated with great fervor across Odisha. At the Shiva Temple at Katasar Ghat, it's highly likely that special prayers, rituals, and possibly a large gathering of devotees would occur on this day. The holy month of Shravana (roughly July-August), which is also dedicated to Lord Shiva, would also see विशेष पूजा (special worship) and potentially more devotees visiting the temple.`,
          ` As the main deity of one of the temples is Goddess Banadurga (a form of Durga), Durga Puja, celebrated in the month of Ashvin (September-October), would undoubtedly be a significant festival here. Expect special decorations, elaborate pujas, and a festive atmosphere.`
        ],
            }
        ],
        calender: [
      ...
      },
      {
        ...
        about_rituals: [`The temple priests would likely begin the day with cleaning the temple premises and preparing for the morning prayers.`,
          ` A sacred bath of the Shiva Lingam (Abhishekam) is a common ritual. This usually involves offering water, milk, ghee, honey, curd, and other sacred substances while chanting mantras.`,
          ` Daily puja would be performed, which includes offering flowers, incense, lamps (diyas), and sometimes food (bhog) to the deity.`,
          ` The waving of lamps before the deity, accompanied by devotional songs and the ringing of bells, is a significant part of the daily worship. This is usually performed in the morning and evening.`,
          `Devotees would have the opportunity for "darshan," which means viewing and receiving blessings from the deity throughout the day.`,
          ` There would be specific times for the temple doors to open for devotees and close in the evening.`,
        ],
        festivals:[
              {
        ...
        description:[` This is undoubtedly the most significant festival dedicated to Lord Shiva and is celebrated with great fervor across Odisha, including at the Baba Jhadeswar Shiv Temple in Deogarh. Devotees often observe a day-long fast, perform special pujas, and stay awake throughout the night, offering prayers. The Lingam is bathed with sacred substances, and the temple is often decorated elaborately. Based on search results, the Jhadeswar Temple near Jharsuguda also considers Maha Shivaratri its main festival, attracting a large number of devotees. It's highly probable that the Deogarh temple shares this significance for Shivaratri.`,
          `The entire month of Shravan (roughly July-August) is considered very auspicious for Lord Shiva. Devotees often visit Shiva temples every Monday during this month, offering special prayers and performing rituals.`,
        ],
            }
        ],
        calender: [
    ...
    products: [
      {
        ...
        about_rituals: [` Devotees are expected to rise around 4:00 AM and perform "Sarana/Darshana" before sunrise. This involves a complete surrender of the self to "Mahima Prabhu" (the Supreme Lord). This act of prostration and uttering the glory of "Alekha" (the formless, indescribable God) is repeated seven times in the morning.`,
          `A similar act of Sarana/Darshana is performed again at noon.`,
          ` Before sunset, the Sarana/Darshana ritual is repeated five times in the evening.`,
          ` Followers adhere to a temperate diet and do not consume any food or water between sunset and sunrise. They also abstain from meat and intoxicants.`,
          `Prayers are typically offered under the open sky, emphasizing the direct connection with the formless divine.`,
          ` Providing food for those in need is considered an essential aspect of Mahima Dharma.`
        ],
        festivals:[
              {
      ...
      },
      {
        ...
        about_rituals: [`The temple priests begin the day by cleaning the temple premises and preparing for the morning prayers.`,
                         `A sacred bathing of the Shiva Lingam (Abhishekam) is a significant ritual. This usually involves offering water, milk, ghee, honey, curd, and other sacred substances while chanting mantras.`,
                         ` Daily puja is performed, which includes offering flowers, incense, lamps (diyas), and sometimes food (bhog) to Lord Chandrashekhar (Shiva).`,
                         `The waving of lamps before the deity, accompanied by devotional songs and the ringing of bells, is performed in the morning and evening.`,
                         ` Devotees have the opportunity to view and receive blessings from Lord Chandrashekhar throughout the day.`,
                         `Uniquely, Kapilash Temple offers 60 mahana bhoga to the deity daily. This is compared to the 60 pauti bhoga offered at the Jagannath Temple in Puri, highlighting a significant aspect of the temple's rituals.`,
                         `There is a tradition of Harihar Bheta after the Mahadeepa (sacred lamp) is raised atop the temple during Maha Shivaratri. This signifies the meeting and unity of Lord Shiva (Hara) and Lord Vishnu (Hari - in the form of Jagannath, who is a Parsa Deva within the temple).`
        ],
        festivals:[
              {
    ...
    products: [
      {
        ...
        saiva_khetra: "no",
        image: "/Jharsuguda-img/Jhadeswar Temple_4.jpg",
        image_arr: ["/Jharsuguda-img/Jhadeswar Temple_4.jpg","/Jharsuguda-img/Jhadeswar Temple.jpg"],
        ...
        about_rituals: [`The temple priests would begin the day by cleaning the temple premises and the shrine of Lord Shiva.`,
                        ` A sacred bath of the self-appearing Sivalingam would likely be performed, using water and possibly other sacred substances like milk, ghee, or honey.`,
                        `A morning puja would be conducted, involving the offering of flowers (bel leaves are significant for Shiva), incense, and a lamp (diya). Mantras dedicated to Lord Shiva would be chanted.`,
                        `A morning aarti (waving of lamps) would be performed before the deity, accompanied by devotional music or chanting.`,
                        `The temple would open for devotees to have darshan (viewing and receiving blessings) of Lord Jhadeswar.`
        ],
        festivals:[
              {
        name:[`Maha Shivaratri`],
      ...
      },
      {
        ...
        adishakti_pitha: "no",
        saiva_khetra: "no",
        image: "/Jharsuguda-img/Pahadimandir front_1.jpg",
        image_arr: ["/Jharsuguda-img/Pahadimandir front_1.jpg","/Jharsuguda-img/Pahadi mandir gate_0.jpg","/Jharsuguda-img/Pahadi mandir inner view_0.jpg"],
        ...
        rituals_img: [null,null,null,null,null,],
        rituals_name: [`Dwaraphita and cleaning`,`Abhishekam`,`Puja`,`Aarti`,`Darshan`],
        about_rituals: [`The day would likely begin with the arrival of the temple priests who would clean the temple premises and the shrines of Lord Shiva and Lord Hanuman.`,
                        `A sacred bath (Abhishekam) of the Shiva Lingam would likely be performed using water and possibly other auspicious substances like milk or honey.`,
                        `A morning puja would be conducted, involving the offering of flowers (including bel leaves, which are significant for Lord Shiva), incense, and a lamp (diya). Mantras dedicated to Lord Shiva and Lord Hanuman would be chanted.`,
                        `A morning aarti (waving of lamps) would be performed before the deities, accompanied by devotional music or chanting.`,
                        ` The temple would then open for devotees to have darshan (viewing and receiving blessings) of Lord Shiva and Lord Hanuman.`,
        ],
        festivals:[
              {
        name:[`Maha ShivaRatri`],
        img:[],
        description:[` Maha Shivaratri is the most significant annual festival at the Pahadi Mandir.A large number of devotees gather at the temple to observe this auspicious occasion.A fair is organized at the Pahadi Mandir during the Maha Shivaratri festival, indicating a vibrant and festive atmosphere.`
        ],
            }
        ],
        calender: [
      ...
      },
      {
        ...
        rituals_img: [null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,],
        ...
        about_rituals: [`Very early in the morning, before sunrise, the temple doors are ceremonially opened. This is often accompanied by specific prayers and the blowing of conch shells.`,
          `The first alati (lamp offering) of the day. Priests wave lamps before the deities, while devotional hymns and music are played, creating an auspicious start to the day.`,
          ` The deities are dressed in their morning attire. This involves removing the previous night's clothes and adorning them with fresh garments, often cotton for the initial part of the day.`,
          ` Symbolic bathing and cleansing rituals are performed for the deities. This involves offering water and other sacred substances. In Puri, this is reflected on mirrors held before the deities.`,
          ` Prayers are offered to the Sun God, an important deity in the Hindu pantheon.`,
          `A light breakfast consisting of fruits, sweets made of coconut and other ingredients, curd, and puffed rice is offered to the deities. This is a smaller offering before the main meals.`,
          `This is the first major meal offering of the day. It includes various cooked rice preparations, curries, and sweets. This bhoga (offering) is elaborate and prepared with great care in the temple kitchen.`,
          ` The temple remains open for devotees to have darshan of Lord Jagannath, Balabhadra, and Subhadra.`,
          `At a specific time, a larger offering of food is made in the Bhoga Mandap (offering hall). This food is later distributed as Mahaprasad, considered highly sacred.`,
          `A second major meal is offered to the deities, similar in its variety to the morning offering.`,
          `Traditionally, the deities are symbolically put to rest for a period in the afternoon. This practice might be adapted or shorter in smaller temples.`,
          ` As dusk approaches, another alati is performed with lamps, accompanied by prayers and devotional music.`,
          ` The evening meal is offered to the deities. The items might differ from the morning and afternoon offerings.`,
          `Periodically, and sometimes as part of the evening rituals, sandalwood paste mixed with other fragrant ingredients is applied to the bodies of the deities to cool them. This is more frequent during the summer months.`,
          ` Before the deities are put to rest, they are adorned with special clothes and floral decorations for the night. In Puri, verses from the Gita Govinda are woven into their night attire.`,
          `A light supper, often consisting of watered rice and sweets, is offered as the last meal of the day.`,
          `The deities are symbolically prepared for sleep. Beds are arranged, and prayers are offered before the temple doors are closed for the night.`
        ],
        festivals:[
              {
    ...
    products: [
      {
        ...
        saiva_khetra: "no",
        image: "/Kalahandi-img/Manikeswari_Temple.jpg",
        image_arr: ["/Kalahandi-img/Manikeswari_Temple.jpg"],
        description: "",
        price: "$999",
...

      {
        ...
        rituals_img: [null,null],
        rituals_name: [`Daily Aarti and Pujas`,`Offerings`, ],
        about_rituals: [` Maa Lankeshwari Temple likely observes daily aarti (waving of lamps) and pujas (prayer rituals) offered to the deity by the temple priests. These rituals are essential for maintaining the temple's sanctity and for devotees to connect with the goddess.`,
          `Devotees visiting the temple on a daily basis would typically offer flowers, incense, and other small tokens of their devotion to Maa Lankeshwari.`
        ],
        festivals: [
          {
            ...
            description: [`This is the most significant annual festival, celebrated in the month of Aswina (September-October), commencing on the night of Mulashtami and lasting for about 15 days.The central ritual involves bringing out the ceremonial swords of Goddess Lankeshwari and Bhairav. After secret rituals, the Maharaja of Kalahandi (or a representative of the royal family) places these swords on either side of the goddess's altar over heaps of rice. The standing position of the swords is believed to indicate the prospects for the region.
               ...
               `The full moon day in the month of Chaitra (March-April) is also observed with special rituals and gatherings at the temple.`
            ],
          }
        ],
        calender: [
    ...
    products: [
      {
        ...
        description:[`This is the most significant festival associated with Lord Jagannath. Celebrated in the month of Asadha (June-July), the deities of Lord Jagannath, Balabhadra, and Subhadra are taken out in a grand procession on elaborately decorated chariots from the main temple to the Gundicha Temple. This festival attracts millions of devotees. Phulbani would likely have its own procession of the deities on smaller chariots through the town.   `,
          ...
          `Just before the Ratha Yatra, after the Anasara period, the deities reappear to the public in their new youthful forms. This occasion is celebrated with great enthusiasm.`,
          ` This festival marks the return journey of the deities from the Gundicha Temple back to the main Jagannath Temple.`,
          ...
          ` The full moon day in the month of Kartika (October-November) is considered auspicious, and special prayers and rituals are offered.`,
          ` Celebrated in the month of Pausha, this festival marks the symbolic coronation of the deities.`
        ],
            }
        ],
        calender: [
  ...
  //KEONJHAR district
  {
    ...
    products: [
      ...
      },
      {
        ...
        image: "/Keonjhar-img/tarini temple.jpg",
        image_arr: ["/Keonjhar-img/tarini temple.jpg","/Keonjhar-img/ghatagaon tarini image.jpg"],
        description: "  Brahmeswar Mahesh Temple is located at Gonasika village  is dedicated to Lord Shiva.The temple is surrounded by a valley and wooded hills.",
        price: "$999",
        details: ` Nestled amidst a picturesque valley and wooded hills, approximately 45 kilometers from Keonjhar, lies the sacred Brahmeswar Mahesh Temple in Gonasika village. This revered shrine is dedicated to Lord Shiva and stands as a significant center of pilgrimage, particularly due to its location on the banks of the holy Baitarani River.
                   The main festival celebrated with immense fervor at the Gonasika temple is Mahashivratri. On this auspicious day, thousands of devotees and visitors converge to partake in the vibrant Jagar Mela. The Brahmeswar Mahesh Mandir holds a prominent place as a famous temple in the Keonjhar district.
                   Adjacent to the temple, a fascinating natural wonder known as Gonasika Gupta Ganga captivates visitors. Here, the Baitarani River mysteriously emerges and flows for a short distance before disappearing underground, seemingly jumping over a stone formation that resembles the nostril of a cow – hence the name "Gonasika" (cow's nose) and "Gupta Ganga" (hidden Ganges).
                   At the foot of the mountain, a small sacred tank called Brahmakunda is situated. Local tradition holds that the Lord Shiva worshipped at the Brahmeswar Mahesh Temple was originally established here by Lord Brahma himself.
                   Adding to its allure, Gonasika boasts breathtaking natural scenery, making it a highly attractive picnic spot, especially during the monsoon and winter seasons when the landscape is at its most vibrant. The serene environment and captivating views draw numerous tourists to this popular destination in the Kendujhar district.
                   Furthermore, the Maa Gangotri Temple is located in close proximity to the Brahmeswar Mahesh Mandir, enhancing the religious significance of the site.
                   Gonasika, also known as Guptaganga, truly stands as a must-visit destination in the Keonjhar district of Odisha, offering a unique blend of natural beauty, rich cultural heritage, and profound religious significance. Its tranquil atmosphere and scenic landscapes provide an ideal setting for spiritual reflection and enjoyable picnics for families and groups alike.`,
        rituals_img: [null,null,null,null,null,null,],
        rituals_name: [`Temple Opening `,`Morning Ablutions and Preparations`,`Puja (Worship):`,`Aarti`,`Devotee Offerings`,`Temple Closing`,],
        ...
        name: ['Legendary Origin'],
        img: [null],
        description: [`The temple's history is deeply intertwined with mythology. It is believed that the Shiva Linga worshipped here was established by Lord Brahma himself. This connection to the creator god adds immense sanctity to the site. The need for the holy Ganga River during a Dasaswamedha yagnya performed by Brahma in Biraja Kshetra led to the emergence of the Baitarani River from Gonasika, considered the Ganga of Odisha.
          Gonasika is renowned as the origin point of the Baitarani River. The river emerges from a stone resembling the nostril of a cow ("Gonasika" meaning cow's nose). Interestingly, the river flows above ground for a short distance before disappearing and then reappearing in the Brahmakunda, a small tank at the foot of the mountain, thus also known as Gupta Ganga (hidden Ganges).
          While the establishment of the Linga is attributed to Brahma, the shrine of Lord Shiva (Brahmeswar Mahesh Temple) is believed to have been constructed later by King Laxmi Narayan Bhanja between 1654 and 1688 AD.
          The association with Brahma and the unique origin of the Baitarani River suggest that Gonasika has been a significant religious site for centuries. The mention of the place as Ekachakranagari in ancient times, with possible links to the Ramayana, further hints at its antiquity.
          While not explicitly detailed for this specific temple, the Keonjhar region has a strong tribal history, and it's possible that earlier forms of worship or local tribal traditions have influenced the site's religious significance over time. `],
            }
          ], 
      },
      {
...

  {
    id: 2900,
    category: "Gajapati",
    image: "/gajpati-img/yudhistra-image.jpg",
    dist: "Gajapati",
    products: [
      {
        id: 2901,
        ...
        saiva_khetra: "yes",
        image: "/gajpati-img/yudhistra-image.jpg",
        image_arr: ["/gajpati-img/yudhistra-image.jpg"],
