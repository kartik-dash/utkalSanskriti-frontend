...
import { setSelectedSouth } from '../../redux/slices/categorySlice';

const SouthCard = () => { 
   const dispatch = useDispatch();
   const navigate = useNavigate();
       const handleSouthClick = (product) => {
              dispatch(setSelectedSouth(product)); 
              navigate(`/south/${product.id}`); 
       };
  return ( 
   <div className="container mx-auto p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-[30px]">
        {categories.map((category) =>
          category.products
            .filter((product) => product.south === "yes")
            .map((product) => (
              <div
                key={product.id}
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <button
                    onClick={() => handleSouthClick(product)}
